...
namespace syncfusion.demoscommon.wpf
{
    ...
    public class DemoInfo
    {
        ...
        /// <summary>
        /// Gets or sets the display title for the sample. if not sets, it default to <see cref="SampleName"/>
        /// </summary>
        public string Title
        { 
            get
    ...
    /// <summary>
    /// Represents tha color pallete for the theme, containing key color brushes.
    /// </summary>
    ...
    /// <summary>
    /// Represents a theme with its identification and visual properties for theme selector UI.
    /// </summary>
    public class Themes
    {
