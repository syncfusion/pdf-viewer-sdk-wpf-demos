...
namespace syncfusion.demoscommon.wpf
{
    ...
    public class BindingErrorListener : TraceListener
    {
        ...
        /// <summary>
        /// Configures the WPF data binding sources to use this listener.
        /// </summary>
        /// <param name="actionLog">The action to be executed when a binding error is detected.</param>
        ...
        /// <summary>
        /// Writes a message to the listener.this implements nothing.
        /// </summary>
        public override void Write(string message) { }

        /// <summary>
        /// Writes a message to the listener followed by a line terminator. This is where binding errors are captured.
        /// </summary>
        /// <param name="message">The binding error message from the trace source</param>
