...
namespace syncfusion.demoscommon.wpf
{
    ...
    public static class AISettings
    {
        ...
        /// <summary>
        /// Asyncronously validate the  current credentials by attempting to make a test call to the API service.
        /// Sets the <see cref="ErrorMessage"/> property on failure
        /// </summary>
        /// <returns>A <see cref="Task{Boolean}"/> that returns <c>true</c> if validation is successful; otherwise, <c>false</c>.</returns>
