...
{
    /// <summary>
    /// Represents the view model for sample items in the demo browser.
    /// </summary>
    public class SamplesViewModel : DemoBrowserViewModel, IDisposable
    {
        /// <summary>
        /// Releases resource used by the <see cref="SamplesViewModel"/> instance.
        /// </summary>
        public void Dispose()
        {
        ...
        /// <summary>
        /// Retrieves a list of demo details specific to the current view model.
        /// </summary>
        /// <returns>A list of <see cref="ProductDemo"/> objects representing the available demos.</returns>
        public override List<ProductDemo> GetDemosDetails()
        {
            var productdemos = new List<ProductDemo>();
            this.ShowcaseDemos = new List<DemoInfo>();

#if !FILEFORMAT && !DocumentSDK && !SPREADSHEETEDITORSDK && !PDFViewerSDK && !DOCXEDITORSDK && !GANTTSDK && !SCHEDULERSDK && !GRIDSDK && !CHARTSDK && !DIAGRAMSDK
            //SMARTComponents
            productdemos.Add(new smartdatagriddemos.wpf.SmartDataGridProductDemos());
            productdemos.Add(new smarttexteditordemos.wpf.SmartTextEditorViewProductDemos());
            //GRIDS
            ...
            var pivotDemo = new pivotgriddemos.wpf.PivotGridProductDemos();
#if NETFRAMEWORK && !STORE
            pivotDemo.ProductCategory = "BUSINESS INTELLIGENCE";
#endif
            productdemos.Add(pivotDemo);
            ...
            productdemos.Add(new layoutdemos.wpf.TabbedWindowProductDemos());
            ...
            //CALENDAR
            productdemos.Add(new datetimedemos.wpf.DateTimeEditProductDemo());
            productdemos.Add(new datetimedemos.wpf.DatePickerProductDemos());
            productdemos.Add(new datetimedemos.wpf.TimePickerProductDemos());
            productdemos.Add(new datetimedemos.wpf.CalendarProductDemos());
            productdemos.Add(new datetimedemos.wpf.TimeSpanEditProductDemo());
            //NOTIFICATION
            productdemos.Add(new notificationdemos.wpf.BusyIndicatorProductDemos());
            productdemos.Add(new notificationdemos.wpf.ProgressbarProductDemos());
            productdemos.Add(new notificationdemos.wpf.BadgeProductDemos());
            productdemos.Add(new notificationdemos.wpf.HubTileProductDemos());
            productdemos.Add(new notificationdemos.wpf.ToastNotificationProductDemos());
#if !UISUITE
            //FILE FORMAT
            ...
            productdemos.Add(new syncfusion.markdowndemos.wpf.MarkdownProductDemos());
            ...
            productdemos.Add(new syncfusion.avatarviewdemo.wpf.AvatarViewProductDemos());
            productdemos.Add(new markdownviewerdemo.wpf.MarkdownViewerProductDemos());
            //CONVERSATIONAL UI
            ...
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.diagrambuilder.wpf.DiagramBuilderDemo), SampleName = "Diagram Builder", ImagePath = "/syncfusion.diagrambuilder.wpf;component/Asset/DiagramBuilder.png", IsShowcase = true });
            ...
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.logicalcircuitdesigner.wpf.LogicalCircuitDesignerDemo), SampleName = "Logic Circuit Diagram", ImagePath = "/syncfusion.logicalcircuitdesigner.wpf;component/Asset/logicCircuitDiagram.png", IsShowcase = true });
            ...
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.floorplanner.wpf.FloorPlannerDemo), SampleName = "Floor Planner", ImagePath = "/syncfusion.floorplanner.wpf;component/Asset/floor-planner-tile.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.networkdiagram.wpf.Views.NetworkDiagramDemo), SampleName = "Network Diagram", ImagePath = "/syncfusion.networkdiagram.wpf;component/Asset/networkdiagram.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.workfloweditor.wpf.WorkFlowEditorDemo), SampleName = "Workflow Editor", ImagePath = "/syncfusion.workfloweditor.wpf;component/Resource/work-flow.png", IsShowcase = true});
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.bpmneditor.wpf.BpmnEditorDemo), SampleName = "BPMN Editor", ImagePath = "/syncfusion.bpmneditor.wpf;component/Asset/bpmneditor.png", IsShowcase = true });
#endif
#if !NET50 && !STORE
            ...
            productdemos.Add(new datagriddemos.wpf.DataGridProductDemos());
            productdemos.Add(new treegriddemos.wpf.TreeGridProductDemos());
            productdemos.Add(new smartdatagriddemos.wpf.SmartDataGridProductDemos() { ProductCategory = "GRIDS" });
            productdemos.Add(new gridcontroldemos.wpf.GridControlProductDemos());
            productdemos.Add(new dropdowndemos.wpf.MultiColumnDropDownProductDemos() { ProductCategory = "GRIDS" });
			...
			this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.stockanalysisdemo.wpf.StockAnalysisDemo), SampleName = "Stock Analysis", ImagePath = "/syncfusion.stockanalysisdemo.wpf;component/Assets/StockAnalysis.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.patientmonitor.wpf.PatientMonitorDemo), SampleName = "Patient Monitor", ImagePath = "/syncfusion.patientmonitor.wpf;component/Assets/PatientMonitor/PatientMonitor.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.weatheranalysis.wpf.WeatherAnalysisDemo), SampleName = "Weather Analysis", ImagePath = "/syncfusion.weatheranalysis.wpf;component/Assets/WeatherAnalysis/WeatherAnalysis.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.expenseanalysis.wpf.ExpenseAnalysisDemo), SampleName = "Expense Analysis", ImagePath = "/syncfusion.expenseanalysis.wpf;component/Assets/ExpenseAnalysis/ExpenseAnalysis.png", IsShowcase = true });
#elif PDFViewerSDK
            ...
            productdemos.Add(new datetimedemos.wpf.TimeSpanEditProductDemo());
#elif GANTTSDK
            productdemos.Add(new ganttdemos.wpf.GanttProductDemos() { ProductCategory= "GANTT" });
            productdemos.Add(new kanbandemos.wpf.KanbanProductDemos() { ProductCategory= "GANTT" });
#elif CHARTSDK
            productdemos.Add(new chartdemos.wpf.ChartProductDemos());
            productdemos.Add(new chartdemos.wpf.Three_DChartProductDemos());
            productdemos.Add(new chartdemos.wpf.SFDateTimeRangeNavigatorDemo());
            ...
            productdemos.Add(new smithchartdemos.wpf.SmithChartProductDemos());
            productdemos.Add(new surfacechartdemos.wpf.SurfaceChartProductDemos());
            productdemos.Add(new barcodedemos.wpf.BarcodeProductDemos());
            productdemos.Add(new heatmapdemos.wpf.HeatMapProductDemos());
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.cardashboard.wpf.CarDashBoardDemo), SampleName = "Car DashBoard", ImagePath = "/syncfusion.cardashboard.wpf;component/Assets/Car Dashboard/CarDashboard.png", IsShowcase = true});
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.salesanalysis.wpf.SalesAnalysisDemo), SampleName = "Sales Analysis", ImagePath = "/syncfusion.salesanalysis.wpf;component/Assets/Sales Analysis/SalesAnalysis.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.stockanalysisdemo.wpf.StockAnalysisDemo), SampleName = "Stock Analysis", ImagePath = "/syncfusion.stockanalysisdemo.wpf;component/Assets/StockAnalysis.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.expenseanalysis.wpf.ExpenseAnalysisDemo), SampleName = "Expense Analysis", ImagePath = "/syncfusion.expenseanalysis.wpf;component/Assets/ExpenseAnalysis/ExpenseAnalysis.png", IsShowcase = true });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.patientmonitor.wpf.PatientMonitorDemo), SampleName = "Patient Monitor", ImagePath = "/syncfusion.patientmonitor.wpf;component/Assets/PatientMonitor/PatientMonitor.png", IsShowcase = true });
