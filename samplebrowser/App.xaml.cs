...
namespace syncfusion.samplebrowser.wpf
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            DemoBrowserViewModel.isMainSB = true;

#if SPREADSHEETEDITORSDK
            DemoBrowserViewModel.IsIOSDKSample = true;
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for Spreadsheet WPF";
#elif GRIDSDK
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Grid Demos for WPF";
#elif DocumentSDK
            DemoBrowserViewModel.IsDocumentSDKSample = true;
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for Document SDK";
#elif DOCXEDITORSDK
            DemoBrowserViewModel.IsIOSDKSample = true;
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for DOCX Editor WPF";
#elif PDFViewerSDK
            DemoBrowserViewModel.IsIOSDKSample = true;
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for PDF Viewer WPF";
#elif SCHEDULERSDK
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Scheduler SDK for WPF";
#elif GANTTSDK
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gantt SDK for WPF";
#elif CHARTSDK
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for Chart WPF";
#elif DIAGRAMSDK
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Diagram Demos for WPF";
#else
            DemoBrowserViewModel.HeaderTitleText = "Syncfusion® Gallery for WPF";
#endif
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
...
#elif GRIDSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-grid-sdk-splash-screen.png");
#elif SPREADSHEETEDITORSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-spreadsheet-editor-sdk-splash-screen.png");
#elif DOCXEDITORSDK
...
#elif SCHEDULERSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-schedulersdk-splash-screen.png");
#elif GANTTSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-gantt-sdk-splash-screen.png");
#elif CHARTSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-chart-sdk-splash-screen.png");
#elif DIAGRAMSDK
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-diagram-sdk-splash-screen.png");
#else
            SplashScreen splashScreen = new SplashScreen(ResourceAssembly, "wpf-splash-screen.png");
            Syncfusion.UI.Xaml.SfToastNotification.WindowsToastBootstrapper.RemoveShortcutOnUnload = true;
            Syncfusion.UI.Xaml.SfToastNotification.WindowsToastBootstrapper.Initialize("ToastNotificationDemo.App", "ToastNotificationDemo");
#endif
...
#if !STORE && !SPREADSHEETEDITORSDK && !PDFViewerSDK && !DOCXEDITORSDK
...
#endif
#if SPREADSHEETEDITORSDK || PDFViewerSDK || DOCXEDITORSDK
            dataContext.SelectedProduct = dataContext.ProductDemos.FirstOrDefault();
#elif !STORE && !SPREADSHEETEDITORSDK && !PDFViewerSDK && !DOCXEDITORSDK
            ...
            try
            {
                if (!string.IsNullOrEmpty(demoID) && demoID.Contains("-"))
                {
                    ...
                    {
                        this.MainWindow = DemosNavigationService.MainWindow == null ? new MainWindow(dataContext) : DemosNavigationService.MainWindow;
